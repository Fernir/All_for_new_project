namespace nManager
{
    ...
    public class nManagerSetting : Settings
    {
        ...
        public float DontHarvestIfPlayerNearRadius = 10f;
        ...
        public float GatheringSearchRadius = 80f;
        ...
        public float MaxDistanceToGoToMailboxesOrNPCs = 1000f;
        ...
        public static nManagerSetting CurrentSetting
        {
            get
            {
                if ((_currentSetting == null) || ((nManager.Wow.ObjectManager.ObjectManager.Me.Name != _lastName) && Usefuls.InGame))
                {
                    Load();
                    _lastName = nManager.Wow.ObjectManager.ObjectManager.Me.Name;
                }
