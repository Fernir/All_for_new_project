            ...
            try
            {
                ...
                if (baseAddress > 0)
                {
                    ...
                    if (obj2.IsValid && (obj2.Guid > 0))
                    {
                        ...
                        string[] asm = new string[] { "call " + (Memory.WowProcess.WowModule + 0x3c47), "test eax, eax", "je @out", "push " + dwAddress, "mov ecx, eax", "call " + (Memory.WowProcess.WowModule + 0x94fb3e), "add esp, 4", "@out:", "retn" };
        ...
        public static void InteractWithBeta(uint baseAddress)
        {
            if (baseAddress > 0)
            {
                ...
                if (obj2.IsValid && (obj2.Guid > 0))
                {
                    ...
                    {
                        ClickToMove.CGPlayer_C__ClickToMove(nManager.Wow.ObjectManager.ObjectManager.Me.Position.X, nManager.Wow.ObjectManager.ObjectManager.Me.Position.Y, nManager.Wow.ObjectManager.ObjectManager.Me.Position.Z, obj2.Guid, 5, 0.5f);
                    }
                    else
                    {
