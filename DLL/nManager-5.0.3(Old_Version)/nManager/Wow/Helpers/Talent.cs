namespace nManager.Wow.Helpers
{
    ...
    public static class Talent
    {
        public static void DoTalents()
        {
            try
            {
                if ((GetNumUnspentTalents() != 0) && Others.ExistFile(string.Concat(new object[] { Application.StartupPath, @"\CombatClasses\Talents\", nManager.Wow.ObjectManager.ObjectManager.Me.WowSpecialization(false), ".talents.txt" })))
                {
