namespace nManager.Wow.MemoryClass
{
    ...
    {
        private int _juilieAkekior;
        internal static List<int> _roemu = new List<int>();
        ...
        public static int GetInjectionBySec()
        {
            try
            {
                for (int i = _roemu.Count - 1; i >= 0; i--)
                {
                    if (_roemu[i] < (Others.Times - 0x3e8))
                    {
                        _roemu.RemoveAt(i);
                    }
                }
        ...
        public int ProcessId
        {
            get
            {
                return this._juilieAkekior;
            }
            set
            {
                this._juilieAkekior = value;
            }
        }
