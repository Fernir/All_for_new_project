                ...
                if (list2.Count > 0)
                {
                    ...
                    foreach (WoWItem item in objectWoWItem)
                    {
                        try
                        {
                            ...
                            {
                                uint num = nManager.Wow.ObjectManager.ObjectManager.Me.Tuecom<uint>(item.GetBaseAddress, 9);
                                UInt128 num2 = nManager.Wow.ObjectManager.ObjectManager.Me.Tuecom<UInt128>(item.GetBaseAddress, 12);
                                if ((list2.Contains(num) && (num2 == nManager.Wow.ObjectManager.ObjectManager.Me.Guid)) && !list4.Contains(item.Entry))
                                {
                                    list.Add(item);
