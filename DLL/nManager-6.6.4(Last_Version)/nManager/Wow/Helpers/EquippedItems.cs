namespace nManager.Wow.Helpers
{
    ...
    public class EquippedItems
    {
        ...
        {
            UInt128 guid = nManager.Wow.ObjectManager.ObjectManager.Me.GetDescriptor<UInt128>((Descriptors.PlayerFields) (0x43d + (invSlot * 4)));
            ...
            try
            {
                ...
                if (itemId.Count > 0)
                {
                    ...
                    list.AddRange(from <>h__TransparentIdentifier1 in (from o in objectWoWItem
                        let itemIdTemp = nManager.Wow.ObjectManager.ObjectManager.Me.Tuecom<uint>(o.GetBaseAddress, 9)
                        select new { <>h__TransparentIdentifier0 = <>h__TransparentIdentifier0, itemGuidOwner = nManager.Wow.ObjectManager.ObjectManager.Me.Tuecom<UInt128>(o.GetBaseAddress, 12) }).Where(predicate) select <>h__TransparentIdentifier1.<>h__TransparentIdentifier0.o);
                }
                return list;
            }
            catch (Exception exception)
        ...
        public static bool IsEquippedItemByGuid(UInt128 guid)
        {
            ...
            {
                descriptor = nManager.Wow.ObjectManager.ObjectManager.Me.GetDescriptor<UInt128>((Descriptors.PlayerFields) (0x43d + (i * 4)));
                if (!(descriptor != guid))
                {
                    flag = true;
                    break;
