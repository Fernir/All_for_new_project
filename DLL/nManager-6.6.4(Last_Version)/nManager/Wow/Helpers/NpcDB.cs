            ...
            try
            {
                ...
                lock (typeof(NpcDB))
                {
                    ...
                    if (num != 0)
                    {
                        ...
                        XmlSerializer.Serialize(Application.StartupPath + @"\Data\NpcDB.xml", _mufuwigo);
                    }
                    num4 = num;
                }
            }
        ...
        private static void JakeugioxikNo()
        {
            try
            {
                lock (typeof(NpcDB))
                {
                    if (_mufuwigo == null)
                    {
                        _mufuwigo = XmlSerializer.Deserialize<List<Npc>>(Application.StartupPath + @"\Data\NpcDB.xml");
                    }
                    if (_mufuwigo == null)
                    {
