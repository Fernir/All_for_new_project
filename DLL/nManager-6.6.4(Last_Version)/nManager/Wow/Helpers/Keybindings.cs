namespace nManager.Wow.Helpers
{
    ...
    {
        private static List<KeybindingsStruct> _xixacefuaneunuIpofirimi = new List<KeybindingsStruct>();
        ...
        public static string GetKeyByAction(nManager.Wow.Enums.Keybindings action, bool autoAssignKeyIfNull = true)
        {
            try
            {
                foreach (KeybindingsStruct struct2 in _xixacefuaneunuIpofirimi)
                {
                ...
                if ((localizedText != "") && (localizedText != "BUTTON3"))
                {
                    ...
                    _xixacefuaneunuIpofirimi.Add(item);
                ...
                if ((str2 != "") && (str2 != "BUTTON3"))
                {
                    ...
                    _xixacefuaneunuIpofirimi.Add(struct4);
                    return str2;
                }
                if (autoAssignKeyIfNull)
                {
                    ...
                    if (!string.IsNullOrEmpty(aFreeKey))
                    {
                        ...
                        _xixacefuaneunuIpofirimi.Add(struct5);
                        return aFreeKey;
                    }
        ...
        public static void ResetList()
        {
            try
            {
                ...
                {
                    _xixacefuaneunuIpofirimi = new List<KeybindingsStruct>();
                }
            }
            catch (Exception exception)
            {
