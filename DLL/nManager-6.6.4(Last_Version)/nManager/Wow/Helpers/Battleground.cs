namespace nManager.Wow.Helpers
{
    ...
    public class Battleground
    {
        ...
        {
            uint num = Memory.WowMemory.Memory.ReadUInt(Memory.WowProcess.WowModule + 0xfabda0);
            for (int i = 1; i <= num; i++)
            {
        ...
        {
            return (Memory.WowMemory.Memory.ReadUInt(Memory.WowProcess.WowModule + 0xfab4a4) > 0);
        }
        ...
        {
            uint num = Memory.WowMemory.Memory.ReadUInt(Memory.WowProcess.WowModule + 0xd00298);
            int num2 = Memory.WowMemory.Memory.ReadByte(Memory.WowProcess.WowModule + 0xd00298) & 1;
            if ((num != 0) && (num2 <= 0))
            {
                return 1;
            }
        ...
        {
            Lua.LuaDoString("SetPVPRoles(false, false, true);", false, true);
        }
