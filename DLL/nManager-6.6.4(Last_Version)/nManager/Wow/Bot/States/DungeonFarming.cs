namespace nManager.Wow.Bot.States
{
    ...
    {
        private List<Instance> _ceulonoeso;
        ...
        public override bool NeedToRun
        {
            get
            {
                ...
                {
                    if (this._ceulonoeso == null)
                    {
                        this._ceulonoeso = XmlSerializer.Deserialize<List<Instance>>(Application.StartupPath + @"\Data\DfInstanceList.xml");
                    }
                    int count = this._ceulonoeso.Count;
                }
                return false;
            }
        }
