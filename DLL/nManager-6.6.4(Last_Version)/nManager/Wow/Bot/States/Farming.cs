namespace nManager.Wow.Bot.States
{
    ...
    {
        private static List<WoWGameObject> _muvaerouqeopae = new List<WoWGameObject>();
        ...
        {
            FarmingTask.Pulse(_muvaerouqeopae);
        }
        ...
        public override bool NeedToRun
        {
            get
            {
                ...
                _muvaerouqeopae = GetFarmableGameObjects;
                return (_muvaerouqeopae.Count > 0);
            }
        }
