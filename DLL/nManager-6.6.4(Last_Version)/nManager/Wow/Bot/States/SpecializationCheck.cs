namespace nManager.Wow.Bot.States
{
    ...
    {
        private WoWSpecialization _oliekorFiwupaube = nManager.Wow.ObjectManager.ObjectManager.Me.WowSpecialization(false);

        public override void Run()
        {
            Logging.Write("We have detected that your Wow Specialization has changed, reloading it.");
            this._oliekorFiwupaube = nManager.Wow.ObjectManager.ObjectManager.Me.WowSpecialization(false);
        ...
        public override bool NeedToRun
        {
            get
            {
                ...
                if ((getLastLevel <= 0) || (getLastLevel < nManager.Wow.ObjectManager.ObjectManager.Me.Level))
                {
                    return false;
                }
                WoWSpecialization specialization = nManager.Wow.ObjectManager.ObjectManager.Me.WowSpecialization(false);
                return ((specialization != WoWSpecialization.None) && (this._oliekorFiwupaube != specialization));
            }
        }
